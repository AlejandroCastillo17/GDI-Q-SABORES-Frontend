        ...
        <div className="sidebar">
            <nav>
                <ul>
                    ...
                    <li>
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  
                            fill="#000000"  class="icon icon-tabler icons-tabler-filled icon-tabler-coin">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M17 3.34a10 10 0 1 1 -15 8.66l.005 -.324a10 10 0 0 1 14.995 -8.336zm-5 2.66a1 1 0 0 0 -1 1a3 3 0 1 0 0 
                    ...
                    <li>
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  
                            fill="#000000"  class="icon icon-tabler icons-tabler-filled icon-tabler-category">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 3h-6a1 1 0 0 0 -1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1 -1v-6a1 1 0 0 0 -1 -1z" />
            ...
            {modal && (
                <div className="modal-s" onClick={cerrarmodal}>
                    <div className="modal-contenedor-s" onClick={(e) => e.stopPropagation()}>
                        <h2>¿Esta completamente seguro que desea cerrar sesion?</h2>
                        <div id="botoness-s">
                            <Button variant="verde" onClick={CerrarSesion}>Aceptar</Button>
                            <Button variant="rojo" onClick={cerrarmodal}>Cancelar</Button>
                        </div>
                    </div>
                </div>
            )}
